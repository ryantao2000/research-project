...
| 检查结构 | [project.py](scripts/project.py)：只读检查本地链接与计划/Results目录配对 |
| 修订通用规则 | [经验与取舍](references/lessons.md)、[来源](PROVENANCE.md)、项目反馈 |

AGENTS保留常驻原则和路由，具体细则下沉到相关INDEX。按实际内容建目录，不创建空台账或为普通答疑立项。工具检查不判断科学接纳、授权或用户掌握。

已授权范围连续完成，Phase、canary、恢复和已批准提交不是新的审批点；资源上限、研究问题、数据及外部动作仍受原授权约束。完成交付就停止，不为用完预算扩展工作。修改规则不能自行扩大权限。
